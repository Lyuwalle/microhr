...
public class MailConstants {
    ...
    public static final String MAIL_QUEUE_NAME = "nurmann.mail.queue";
    public static final String MAIL_EXCHANGE_NAME = "nurmann.mail.exchange";
    public static final String MAIL_ROUTING_KEY_NAME = "nurmann.mail.routing.key";
}
