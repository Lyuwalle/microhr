...
<!--      分页栏，有两个参数，每页的条数  和  点击第几页-->
      <div style="display: flex;justify-content: flex-end">
<!--        @current-change表示currentPage改变时会触发-->
<!--        @size-change表示每页条数改变时会触发-->
        <el-pagination
            background
              ...
              <el-col :span="6">
                <el-form-item label="所属部门:" prop="departmentId">
                  <el-popover
                      ...
                      trigger="manual"
                      v-model="popVisible">
                    <el-tree default-expand-all @node-click="handleNodeClick" :data="allDeps" :props="defaultProps">
                    </el-tree>
                    <div slot="reference" @click="showDepView"
